...
class Envs:
    ...
    # Debug: emit device [KVSUM], D2H/H2D [KVCOPY], and L3 [KVHOST] digests.
    # SGLANG_DSV4_KV_DIGEST_LAYERS overrides the default KVSUM layer set
    # (all compress layers); comma-separated layer ids.
